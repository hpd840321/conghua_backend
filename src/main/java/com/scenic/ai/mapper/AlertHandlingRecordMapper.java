...
public interface AlertHandlingRecordMapper extends BaseMapper<AlertHandlingRecord> {
     ...
     * @return 统计结果
     */
    List<Map<String, Object>> countByHandleMethod(
     ...
     * @return 统计结果
     */
    List<Map<String, Object>> countByHandleResult(
            @Param("startTime") LocalDateTime startTime,
            @Param("endTime") LocalDateTime endTime);
     ...
     * @return 处理记录列表
     */
    List<AlertHandlingRecord> findByConditions(@Param("params") Map<String, Object> params);
