...
public interface IDensityAnalysisService extends IService<DensityAnalysis> {
     ...
     * @return 密度趋势数据
     */
    List<Map<String, Object>> getDensityTrend(String deviceCode, String tourismName, LocalDateTime startTime, LocalDateTime endTime);
     ...
     * @return 密度级别分布数据
     */
    List<Map<String, Object>> getDensityLevelDistribution(String deviceCode, String tourismName, LocalDateTime startTime, LocalDateTime endTime);
     ...
     * @return 密度分析数据列表
     */
    List<DensityAnalysis> getDensityByTimeRangeAndTourism(LocalDateTime startTime, LocalDateTime endTime, String tourismName);
