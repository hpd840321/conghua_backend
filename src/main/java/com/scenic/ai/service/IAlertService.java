...
public interface IAlertService extends IService<Alert> {
         ...
         * @return 是否更新成功
         */
        boolean handleBatchStatus(List<Long> ids, Integer status);
         ...
         * @return 是否处理成功
         */
        boolean handleBatchAlerts(List<Long> ids);
         ...
         * @return 告警列表
         */
        List<Alert> listByDevice(String deviceCode, LocalDateTime startTime, LocalDateTime endTime);
         ...
         * @return 告警列表
         */
        List<Alert> listByTourism(String tourismName, LocalDateTime startTime, LocalDateTime endTime);
         ...
         * @return 告警类型分布
         */
        List<Map<String, Object>> countTypeDistribution(LocalDateTime startTime, LocalDateTime endTime);
         ...
         * @return 告警级别分布
         */
        List<Map<String, Object>> countLevelDistribution(LocalDateTime startTime, LocalDateTime endTime);
         ...
         * @return 告警状态分布
         */
        List<Map<String, Object>> countStatusDistribution(LocalDateTime startTime, LocalDateTime endTime);
         ...
         * @return 景区告警分布
         */
        List<Map<String, Object>> countTourismDistribution(LocalDateTime startTime, LocalDateTime endTime);
         ...
         * @return 设备告警分布
         */
        List<Map<String, Object>> countDeviceDistribution(LocalDateTime startTime, LocalDateTime endTime);
         ...
         * @return 处理记录列表
         */
        List<AlertHandleRecord> listHandleRecords(Long alertId);
         ...
         * @return 未处理告警列表
         */
        List<Alert> listUnhandledAlerts(String deviceCode, String alertType);
         ...
         * @return 未处理的告警列表
         */
        List<Alert> listUnhandledAlertsByTourism(String deviceCode, String tourismName);
