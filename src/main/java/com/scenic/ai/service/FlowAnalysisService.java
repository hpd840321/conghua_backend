...
public interface FlowAnalysisService extends IService<FlowAnalysis> {
     ...
     * @return 方向-数量映射
     */
    List<Map<String, Object>> getFlowDirectionDistributionV2(String deviceCode, String tourismName,
                                                           LocalDateTime startTime, LocalDateTime endTime);
     ...
     * @return 总客流量
     */
    Integer selectTotalFlowCount(LocalDateTime startTime, LocalDateTime endTime);
     ...
     * @return 客流方向统计数据
     */
    List<FlowAnalysis> selectFlowDirectionStats(LocalDateTime startTime, LocalDateTime endTime);
     ...
     * @return 分页结果
     */
    IPage<FlowAnalysis> selectFlowAnalysisPage(Page<FlowAnalysis> page, FlowAnalysis flowAnalysis);
} 