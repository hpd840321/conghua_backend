...
<body>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="chart-container">
                    ...
                    <div id="densityTrend" style="height: 400px;"></div>
                </div>
            </div>
        </div>
    ...
    <script src="${pageContext.request.contextPath}/static/js/density-statistics.js"></script>
</body>
</html> 